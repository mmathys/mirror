...
@chromium-browser --kiosk --force-device-scale-factor=2 --disable-cache --disable-restore-session-state --disable-component-update --noerrdialogs https://mirror-1598972059056.web.app